...
export const SAFETY_MENU = {
  automotive: ['HARA', 'FSC', 'TSC', 'FTA', 'DFA', 'FMEA', 'DFMEA', 'SYS_DFMEA'],
  aerospace:  ['PHL_PHA', 'FHA', 'FTA', 'DFA', 'FMEA', 'DFMEA', 'SYS_DFMEA'],
  military:   ['PHL_PHA', 'FHA', 'FTA', 'DFA', 'FMEA', 'DFMEA', 'SYS_DFMEA'],
};
