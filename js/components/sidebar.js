...
export const SAFETY_MENU = {
  automotive: ['HARA', 'FSC', 'TSC', 'FTA', 'DFA', 'FMEA', 'DFMEA', 'SYS_DFMEA', 'FMEA_BETA'],
  aerospace:  ['PHL_PHA', 'FHA', 'FTA', 'DFA', 'FMEA', 'DFMEA', 'SYS_DFMEA', 'FMEA_BETA'],
  military:   ['PHL_PHA', 'FHA', 'FTA', 'DFA', 'FMEA', 'DFMEA', 'SYS_DFMEA', 'FMEA_BETA'],
};
...
function buildReviewsEntry({ base, activePage }) {
