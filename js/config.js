...
export const DEFAULT_FHA_FIELDS = [
  ...
  { key: 'effect_item',        label: 'Item Effect',          type: 'text',         required: false, visible: true  },
  { key: 'effect_environment', label: 'Environmental Effect', type: 'text',         required: false, visible: true  },
  { key: 'effect_3rdparties',  label: '3rd Parties Effect',   type: 'text',         required: false, visible: true  },
